...
class MiniTextDataset(MiniDataset):
    ...
    def __init__(
        ...
        super().__init__(file_path, processor, max_seq_len, batch_size)
        ...
        self.text_processor = MiniTextProcessor(self.processor)
...
class MiniJsonDataset(MiniDataset):
    ...
    def __init__(
        ...
        self.data_processor = MiniJsonProcessor(self.processor)
